...
|---|---|
| `dashboard-search.js` | **Lakshya Goyal** (logic, movie + TV fetching, season handling), **Mohamad Ehsan Qasemi** (CSS / styling and responsive design) |
